                        ...
                        <tbody>
                            ...
                            ?>
                                        <tr>
                                            ...
                                            <td><a href="update dep.php?id=<?php echo $result['Department_Id']; ?>"><i class="fas fa-edit">Edit</i></a></td>
                                            <td><a href="delete dep.php?id=<?php echo $result['Department_Id']; ?>"><i class="fas fa-trash-alt">Delete</i></a></td>
                                        </tr>
                                        <?php 
                                            }
                                            }
