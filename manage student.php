                        ...
                        <tbody>
                            ...
                            ?>
                                        <tr>
                                            ...
                                            <td><a href="update student.php?id=<?php echo $result['S_Id']; ?>"><i class="fas fa-edit">Edit</i></a></td>
                                            <td><a href="delete student.php?id=<?php echo $result['S_Id']; ?>"><i class="fas fa-trash-alt">Delete</i></a></td>
                                        </tr>
                                        <?php 
                                            }
                                            }
