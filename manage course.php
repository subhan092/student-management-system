                        ...
                        <tbody>
                            ...
                            ?>
                                        <tr>
                                            ...
                                            <td><a href="update course.php?id=<?php echo $result['Course_Id']; ?>"><i class="fas fa-edit">Edit</i></a></td>
                                            <td><a href="delete course.php?id=<?php echo $result['Course_Id']; ?>"><i class="fas fa-trash-alt">Delete</i></a></td>
                                        </tr>
                                        <?php 
                                            }
                                            }
